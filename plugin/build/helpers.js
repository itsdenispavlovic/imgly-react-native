...
exports.replaceTaggedConfiguration =
  exports.taggedConfigurationBlock =
  exports.taggedReplacementBlock =
  exports.parseSDKVersions =
  exports.previousContent =
    void 0;
...
function parseSDKVersions(content, configurationObject) {
  var _a, _b, _c, _d;
  let source = previousContent(
    constants_1.ConfigurationTag.SDKVersions,
    content
  );
  if (source != null) {
    ...
    const newBuildTools = `buildToolsVersion = "${
      (_a =
        configurationObject === null || configurationObject === void 0
          ? void 0
          : configurationObject.buildToolsVersion) !== null && _a !== void 0
        ? _a
    ...
    const newMinSdkVersion = `minSdkVersion = ${
      (_b =
        configurationObject === null || configurationObject === void 0
          ? void 0
          : configurationObject.minSdkVersion) !== null && _b !== void 0
        ? _b
        : Constants.defaultMinSdkVersion
    }`;
    const newCompileSdkVersion = `compileSdkVersion = ${
      (_c =
        configurationObject === null || configurationObject === void 0
          ? void 0
          : configurationObject.compileSdkVersion) !== null && _c !== void 0
        ? _c
    ...
    const newTargetSdkVersion = `targetSdkVersion = ${
      (_d =
        configurationObject === null || configurationObject === void 0
          ? void 0
          : configurationObject.targetSdkVersion) !== null && _d !== void 0
        ? _d
    ...
    source = source.replace(newSupportLibVersionRegEx, newSupportLibVersion);
    return source;
  }
  return;
}
